  ...
  for (var i = 0; i < data.length; i++) {
      ...
      for (var j = 2; j < Number(data[i].length); j++) {
          ...
          if (Number(teamValue) > 0 && Number(teamValue) < 11) {
              ...
              if (data[i][j][8])
                  t += '<a href="game/' + data[i][j][12] + '/preview.html" onclick="clickcr(this, "sch.gamerecord", "", "", event);"><img width="61" height="23" alt="경기결과" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>';
              if (data[i][j][9])
                  t += '<a href="game/' + data[i][j][12] + '/relay.html" onclick="clickcr(this, "sch.gamerecord", "", "", event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>';
              if (data[i][j][10])
                  t += '<a href="game/' + data[i][j][12] + '/video.html" onclick="clickcr(this, "sch.gamevod", "", "", event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>';
